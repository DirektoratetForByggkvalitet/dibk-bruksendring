    ...
    <Primitives.Wizard>
      <IntroMain>
        ...
        <Primitives.Paragraphs.Lead>
          Vil du endre hva du bruker et rom i boligen din til? Finn ut om du må
          sende byggesøknad til kommunen, eller om du kan slippe å søke. Du får
          også vite hvilke byggeregler du må følge.
          <br />
          <br />
          Veiviseren gjelder for deg som ønsker å endre på ett enkelt rom uten å
          flytte vegger eller dører.
        </Primitives.Paragraphs.Lead>
        <section>
          <div>
            <Primitives.Heading.H2>Før du begynner</Primitives.Heading.H2>
            <Primitives.Paragraphs.P>
              Før du tar veiviseren bør du kontakte kommunen og få tak i siste
              godkjente plantegning av boligen din. Plantegningen viser hva du
              har lov å bruke rommene i boligen din til. Du vil få bruk for
              denne informasjonen i veiviseren.
            </Primitives.Paragraphs.P>
            <br />
            ...
            <Primitives.Paragraphs.P>
              Det er du som er ansvarlig for at alle lover og regler blir fulgt
              når du bygger. Er det noen spørsmål du er usikker på underveis? Du
              kan ta en pause og fortsette senere. Nettleseren husker hvor du
              var.
            </Primitives.Paragraphs.P>
          </div>
        </section>
